...
from ift6163.envs import register_envs
...
class RL_Trainer(object):
    ...
    def collect_training_trajectories(self, itr, initial_expertdata, collect_policy, num_transitions_to_sample, save_expert_data_to_disk=False):
        ...
        """
        # TODO (Done): get this from previous assignment
        ...
        # Don't do this for MBRL. Just use the random collect policy the first time.
        # if itr == 0:
        #     with open(os.path.join('..', '..', '..', initial_expertdata), 'rb') as file:
